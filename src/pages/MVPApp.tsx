...
import { ExpressionMeasurement } from '../components/ExpressionMeasurement';
...
export default function MVPApp() {
    ...
    useVoiceInteraction();
    const { isSettingsOpen, isVisualizationSettingsOpen, userMessage, aiResponse, currentPage } = useAppStore();
    ...
    // Render Expression Measurement page if navigated
    if (currentPage === 'expression-measurement') {
        return <ExpressionMeasurement />;
    }
